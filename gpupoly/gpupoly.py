...
class Network:
    if os.name == 'nt': # Running in Windows
        os.add_dll_directory("/usr/bin")
        _lib = ctypes.cdll.LoadLibrary("/home/vladi/ERAN/ELINA/gpupoly/gpupoly.dll")

    else: # Not running in Windows
        # _lib=ctypes.cdll.LoadLibrary('/home/vladi/ERAN/ELINA/gpupoly/dpGPUlib.so.0.13')
